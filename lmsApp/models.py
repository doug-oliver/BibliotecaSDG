...
class Books(models.Model):
    ...
    seminario = models.CharField(max_length=3, choices=(('1','Seminário Teologia'), ('2','Seminário Filosofia'), ('3','Menor/Propedêutico')), default = 1)
    description = models.TextField(blank=True, null= True)
...
class Borrow(models.Model):
    ...
    student = models.ForeignKey(User, on_delete=models.CASCADE, related_name="user_id_fk")
    ...
    class Meta:
        verbose_name_plural = "Transações de Impréstimos"
